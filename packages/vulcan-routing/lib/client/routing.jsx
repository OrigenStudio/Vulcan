...
Meteor.startup(() => {
  ...
  const options = {
    rehydrateHook(data) {
      // FIXME not sure how to migrate this
      ...
      //     initialState &&
      //     initialState.apollo &&
      //     !_.isEmpty(initialState.apollo.data) &&
      ...
      // runCallbacks('router.client.rehydrate', {
      //   initialState,
      //   store: context.store,
      // });
    },
    ...
    wrapperHook(appGenerator) {
      ...
      const app = runCallbacks(
        'router.client.wrapper',
        appGenerator({
          onUpdate: () => {
          ...
          render: applyRouterMiddleware(
            useScroll((prevRouterProps, nextRouterProps) => {
